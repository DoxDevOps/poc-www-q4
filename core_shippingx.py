...
recipients = ["+265998006237", "+265991450316", "+265995246144", "+265994427700", "+265992600883", "+265999679975", "+265999611280"]
    ...
    while(count < 3):
        ...
        if subprocess.call(['ping', param, '1', site['ip_address']]) == 0:
            ...
            for recipient in recipients:
                msg = "Hi there,\n\nDeployment of CORE to v4.9.4 for " + site['name'] + " completed succesfully.\n\nThanks!\nEGPAF HIS."
                params = {
            ...
            if count == 3:
                for recipient in recipients:
                    msg = "Hi there,\n\nDeployment of CORE to v4.9.4 for " + site['name'] + " failed to complete after several connection attempts.\n\nThanks!\nEGPAF HIS."
                    params = {
                        "api_key": os.getenv('API_KEY'),
                        "recipient": recipient,
                        "message": msg
